...
class NewsAPITestCase(TestCase):
    ...
    def test_get_news(self, my_mock):
        ...
        req_mock.json.return_value = 'Crypto finance firm BlockFi files for bankruptcy following the fall of FTX'
        
        my_mock.get.return_value = req_mock

        self.assertEqual('Crypto finance firm BlockFi files for bankruptcy following the fall of FTX', get_news('Finance'))
